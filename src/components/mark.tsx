...
export function Mark({
  ...
  const body = onDark ? "var(--paper)" : "var(--ink)";
  ...
  return (
    <svg viewBox="0 0 48 48" className={cn("size-14 shrink-0", className)} aria-hidden>
      ...
      <rect x="15" y="6" width="18" height="32" rx="3" fill="var(--rust)" />
      <circle cx="21" cy="16" r="2.2" fill="var(--night)" />
      <circle cx="27" cy="16" r="2.2" fill="var(--night)" />
      <path
